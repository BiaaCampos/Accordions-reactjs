...
import "../src/RelatorioPrescricaoInicialInsulina.css";

const RelatorioPrescricaoInicialInsulina = () => {
  return (
    <div className="div-insulina">
      <div className="div-relatorio-manutencao-insulina">
        <div className="div-table-relatorio-insulina">
          <table className="table-relatorio">
              ...
              <td colSpan={"3"} className="td-relatorio-medico">
                ...
                <div className="div-texto-relatorio-insulina">
                  <p>
                    ...
                    necessita receber análogo de insulina de ação lenta e
                    rápida, para otimizar o tratamento e alcançar resultados
                    necessários como diminuir hupoglicemias e melhor do tempo no
                    alvo e queda de hemoglobina glicada. Com tais insulinas terá
            ...
            <tr >
              <th className="tamanho-table table-insulina">N° frascos</th>
              <th className="tamanho-table table-insulina">ml por frasco</th>
              <th className="tamanho-table table-insulina">Nome e tipo de Insulina</th>
            </tr>
            <tr>
              <td className="table-insulina">
                <input
                  type={"number"}
