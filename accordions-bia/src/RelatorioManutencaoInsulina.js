...
import "../src/RelatorioManutencaoInsulina.css";
      ...
      <div className="div-relatorio-manutencao-insulina">
        <div className="div-table-relatorio-insulina">
          <table className="table-relatorio">
            ...
            <tr>
              <th className="tamanho-table table">N° frascos</th>
              <th className="tamanho-table table">ml por frasco</th>
              <th className="tamanho-table table">Nome e tipo de Insulina</th>
            </tr>
            <tr>
              <td className="table">
                <input
