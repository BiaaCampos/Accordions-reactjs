...
import "../src/ReceitaInsulinaRapida.css";

const ReceitaInsulinaRapida = () => {
  return (
    <div className="table-nova">
        ...
        <div className="div-table-relatorio-insulina">
          <table className="table-relatorio">
            ...
            <tr>
              <td colSpan={"3"} className="td-relatorio-medico">
                ...
                <div className="div-relatorio-medico-texto">
                  ...
                  <textarea
                    className="text-area-insulina-rapida"
                    placeholder="...."
                  ></textarea>
                </div>
                <div className="div-relatorio-medico-texto">
                  <p>
                    2.2 - Prescrição baseada na razão de CHO e fator de
                    sensibilidade &#40;FS&#41;:
                  </p>
                  <div>
                    <p>
                      Aplicar pré refeições, 1 unidade de insulina a cada{" "}
                      <input className="input-2-2" type={"number"}></input>{" "}
                      gramas de CHO da contagem.
                    </p>
                  </div>
                  <div>
                    <p>
                      Para corrigir glicemia considerar que 1 unidade de
                      insulina reduz a glicemia em{" "}
                      <input className="input-2-2" type={"number"}></input>{" "}
                      mg/dL. Glicemia alvo de 70 a 180 mg/dL.
                    </p>
                  </div>
                </div>
                <div className="p-necessita-receber">
                  <p>
                    2.3 - Prescrição por tabela e baseada no fator de
                    sensibilidade &#40;FS&#41; para glicemia de 100 mg/dL:
                  </p>
                </div>
              </td>
            </tr>
            <tr>
              ...
              <th className="tamanho-table">
                U de insulina aproximada pelo médico
              </th>
            </tr>
            <tr>
              <td className="central-insulina-rapida">Se menor 100mg/dL</td>
              <td className="central-insulina-rapida">
                <input
                  type={"number"}
            ...
            <tr>
              <td colSpan={"3"}>
                <div className="p-3-agulhas">
                  <p>
                    3- AGULHAS bd ultra fine 32x4, conector Luer Lock
                    descartável estéril --- 1 caixa ao mês
                  </p>
                </div>
              </td>
            </tr>
